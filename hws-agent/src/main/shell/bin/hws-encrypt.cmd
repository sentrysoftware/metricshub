...
@REM -----------------------------------------------------------------------------
@REM Hardware Sentry Agent Encrypt Script
@REM
...
:checkHwsCmd
if exist "%HWS_HOME%\bin\hws-encrypt.cmd" goto init
goto error
...
set HWS_PASSWORD_ENCRYPT_LOADER="-Dloader.main=com.sentrysoftware.hardware.agent.security.PasswordEncrypt org.springframework.boot.loader.PropertiesLauncher"
