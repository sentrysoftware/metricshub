package com.sentrysoftware.matrix.connector.model.monitor.job.source.type.winrm;
...
public class WinRMSource extends Source {

	private static final long serialVersionUID = -3438167724086266056L;

	private String wbemQuery;
	private String wbemNamespace;

	@Builder
	public WinRMSource(List<Compute> computes, boolean forceSerialization, String wbemQuery,
	...
	@Override
	public WinRMSource copy() {
		return WinRMSource.builder()
				.index(index)
				.key(key)
