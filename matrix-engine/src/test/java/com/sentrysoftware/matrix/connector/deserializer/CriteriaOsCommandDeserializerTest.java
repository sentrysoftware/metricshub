...
import com.sentrysoftware.matrix.connector.model.identity.criterion.OsCommand;
...
class CriteriaOsCommandDeserializerTest extends DeserializerTest {
	...
	void testDeserializeOsCommand() throws IOException {
		...
		expected.add(
				new OsCommand("osCommand", true, commandLine, errorMessage, expectedResult, executeLocally, timeout));
