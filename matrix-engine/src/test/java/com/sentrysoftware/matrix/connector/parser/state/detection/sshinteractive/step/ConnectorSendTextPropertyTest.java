...
import com.sentrysoftware.matrix.connector.parser.state.detection.sshinteractive.step.ConnectorSendTextProperty;
...
class ConnectorSendTextPropertyTest {
	...
	void testGetConnectorProperties() {
		assertEquals(
				...
				ConnectorSendTextProperty.getConnectorProperties().stream()
