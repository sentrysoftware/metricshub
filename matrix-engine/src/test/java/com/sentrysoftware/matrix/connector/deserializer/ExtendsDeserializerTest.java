...
class ExtendsDeserializerTest {
	...
	void testDeserializeExtends() throws IOException {
		...
		assertEquals(List.of("Connector1", "Connector2"), extendsConnectors);
	}
	...
	void testDeserializeExtendsSingleValueAcceptedAsList() throws IOException {
		...
		assertEquals(List.of("Connector1"), extendsConnectors);
	}
	...
	void testDeserializeExtendsNullValueAcceptedAsEmptyList() throws IOException {
		...
		assertEquals(Collections.emptyList(), extendsConnectors);
	}
}
