...
[ -d APPLICATION_DIRECTORY ] && (cd APPLICATION_DIRECTORY && (ln -s lib/config config) && (ln -s lib/security security) && (ln -s lib/otel otel) && (ln -s lib/site site) && (ln -s lib/logs logs) && (ln -s lib/LICENSE LICENSE))
...
[ -L APPLICATION_DIRECTORY/config ] && rm -f APPLICATION_DIRECTORY/config
[ -L APPLICATION_DIRECTORY/security ] && rm -f APPLICATION_DIRECTORY/security
[ -L APPLICATION_DIRECTORY/otel ] && rm -f APPLICATION_DIRECTORY/otel
[ -L APPLICATION_DIRECTORY/site ] && rm -f APPLICATION_DIRECTORY/site
[ -L APPLICATION_DIRECTORY/logs ] && rm -f APPLICATION_DIRECTORY/logs
[ -L APPLICATION_DIRECTORY/LICENSE ] && rm -f APPLICATION_DIRECTORY/LICENSE
