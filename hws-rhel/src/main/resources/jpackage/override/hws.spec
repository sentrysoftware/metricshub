...
[ -L APPLICATION_DIRECTORY/config ] && rm APPLICATION_DIRECTORY/config
[ -L APPLICATION_DIRECTORY/security ] && rm APPLICATION_DIRECTORY/security
[ -L APPLICATION_DIRECTORY/otel ] && rm APPLICATION_DIRECTORY/otel
[ -L APPLICATION_DIRECTORY/site ] && rm APPLICATION_DIRECTORY/site
[ -L APPLICATION_DIRECTORY/logs ] && rm APPLICATION_DIRECTORY/logs
[ -L APPLICATION_DIRECTORY/LICENSE ] && rm APPLICATION_DIRECTORY/LICENSE
