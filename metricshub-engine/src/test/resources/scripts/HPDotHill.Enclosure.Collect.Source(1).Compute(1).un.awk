...
$1 ~ /\057OBJECT/ && (basetype == "system" || basetype == "system-information") {print ("MSHW;"basetype";"DisplayName";"vendor";"model";");
...
$1 ~ /\057OBJECT/ && basetype == "enclosure-environmental" {print ("MSHW;"basetype";"bladeSerial";"bladeID";"healthnumeric";"productID";");
...
$1 ~ /\057OBJECT/ && basetype == "controllers" {print ("MSHW;"basetype";CTRL-"ID";"healthnumeric";"healthreason";"position";"description";SN: "serialnumber";SC FW: "firmwareversion";");
...
$1 ~ /\057OBJECT/ && basetype == "network-parameters" {print ("MSHW;"basetype";"ID";Ethernet;"        ";"           ";"healthnumeric";"healthreason";");
...
($1 ~ /<PROPERTY/ && basetype == "name") {
     ...
     if ($0 ~ /name="actual.speed"/) {actualspeed=setValue($0);gsub(/[gG][Bb]*/,"000",actualspeed);gsub(/[\056A-Za-z]/,"",actualspeed);} 
     if ($0 ~ /name="status"/) {healthnumeric=setValue($0);if (status=="Not Present") {basetype=""}}
     }
# Print Must Matchup with Management Ports
$1 ~ /\057OBJECT/ && (basetype == "port" || ( basetype == "name" && media != "") ) {basetype = "port"
...
$1 ~ /\057OBJECT/ && basetype == "compact-flash" {print ("MSHW;"basetype";CF-"ID";"healthnumeric";"cacheflush" "healthreason";"        ";"name       ";"            ";");
...
$1 ~ /\057OBJECT/ && basetype == "drives" {print ("MSHW;"basetype";"ID";"enclosureid";"serialnumber";"vendor";"model";"revision";"type";"size";"sizenumeric";"healthnumeric";"healthreason";");
...
$1 ~ /\057OBJECT/ && basetype == "virtual-disks" {print ("MSHW;"basetype";"name";"size";"sizenumeric";"freespace";"freespacenumeric";"raidtype";"diskcount";"healthnumeric";"healthreason";");
...
$1 ~ /\057OBJECT/ && basetype == "enclosure-components" {if (type !~ /[Dd]isk/) {
...
$1 ~ /\057OBJECT/ && basetype == "fan" {print ("MSHW;"basetype";;"location";"status";;;;;");
...
$1 ~ /\057OBJECT/ && basetype == "power-supplies" {print ("MSHW;"basetype";;"location";"status";PN: "partnnumber";SN: "serialnumber";;;");
...
$1 ~ /\057OBJECT/ && basetype == "enclosure-fru" {print ("MSHW;"basetype";"bladeSN";"componentSN";"componentID";")
