...
@Slf4j
public class HttpTestRequestExecutor {
	...
	public String executeHttp(
		...
		final HttpTestConfiguration httpConfiguration = (HttpTestConfiguration) httpRequest.getHttpConfiguration();
	...
	private String doHttpRequest(
		...
		final HttpTestConfiguration httpConfiguration,
