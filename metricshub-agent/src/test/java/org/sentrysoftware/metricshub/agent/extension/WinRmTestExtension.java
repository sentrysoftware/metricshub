 ...
 */
@Slf4j
public class WinRmTestExtension implements IProtocolExtension {
	...
	public boolean isValidConfiguration(IConfiguration configuration) {
		return configuration instanceof WinRmTestConfiguration;
	}
	...
	public Map<Class<? extends IConfiguration>, Set<Class<? extends Source>>> getConfigurationToSourceMapping() {
		return Map.of(WinRmTestConfiguration.class, Set.of(WmiSource.class));
	}
	...
	public IConfiguration buildConfiguration(
		...
		try {
			final WinRmTestConfiguration winRmConfiguration = newObjectMapper()
				.treeToValue(jsonNode, WinRmTestConfiguration.class);
