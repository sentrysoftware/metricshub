...
class UpDownCounterSuppressZerosStateMetricRecorderTest {

	@Mock
	private StateSetMetric mockMetric;

	private UpDownCounterSuppressZerosStateMetricRecorder recorder;
	...
	void setUp() {
		...
		recorder =
			UpDownCounterSuppressZerosStateMetricRecorder
				...
				.withDescription("Test up-down counter suppress zeros state metric")
