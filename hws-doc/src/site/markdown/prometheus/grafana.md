...
3. run both **${solutionName}** and the **Prometheus server**.
...
The **Hardware Sentry - Main** and **Hardware Sentry - Site** dashboards provide the number of **Critical Alerts** and **Warning Alerts** detected by **${solutionName}**. Additional information about the **Current Alerts** is provided in the **Hardware Sentry - Main** and **Hardware Sentry - Host** dashboards.
