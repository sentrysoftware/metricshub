package com.sentrysoftware.metricshub.converter.state.computes.and;
...
public class AndProcessor extends AbstractStateConverter {

	private static final Pattern PATTERN = Pattern.compile(
		ConversionHelper.buildComputeKeyRegex("and"),
