...
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_CORRECTED_ERROR_ALARM_THRESHOLD;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_CORRECTED_ERROR_COUNT;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_CORRECTED_ERROR_WARNING_THRESHOLD;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_CURRENT_SPEED;
...
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_MAXIMUM_SPEED;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_MAX_POWER_CONSUMPTION;
...
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_CPU_ENERGY;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_CPU_ERRORS;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_CPU_ERRORS_LIMIT_CRITICAL;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_CPU_ERRORS_LIMIT_DEGRADED;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_CPU_POWER;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_CPU_POWER_LIMIT;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_CPU_PREDICTED_FAILURE;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_CPU_SPEED;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_CPU_SPEED_LIMIT;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_CPU_STATUS;
...
public class CpuConverter extends AbstractMappingConverter {
	...
	private String buildNameValue(
		...
		// sprint("%s (%s - %s - %s)", $1, $2, $3, megaHertz2HumanFormat($4))
		return format
