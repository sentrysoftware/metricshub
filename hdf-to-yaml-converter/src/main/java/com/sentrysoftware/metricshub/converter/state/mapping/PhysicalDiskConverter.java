...
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_DEVICE_NOT_READY_ERROR_COUNT;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_DISPLAY_ID;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_ENDURANCE_REMAINING;
...
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_HARD_ERROR_COUNT;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_ILLEGAL_REQUEST_ERROR_COUNT;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_MEDIA_ERROR_COUNT;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_MODEL;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_NO_DEVICE_ERROR_COUNT;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_PREDICTED_FAILURE;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_RECOVERABLE_ERROR_COUNT;
...
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_TRANSPORT_ERROR_COUNT;
...
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_PHYSICAL_DISK_ENDURANCE_UTILIZATION_REMAINING;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_PHYSICAL_DISK_ERRORS;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_PHYSICAL_DISK_ERRORS_DEVICE_NOT_READY;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_PHYSICAL_DISK_ERRORS_HARD;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_PHYSICAL_DISK_ERRORS_ILLEGAL_REQUEST;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_PHYSICAL_DISK_ERRORS_MEDIA;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_PHYSICAL_DISK_ERRORS_NO_DEVICE;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_PHYSICAL_DISK_ERRORS_RECOVERABLE;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_PHYSICAL_DISK_ERRORS_TRANSPORT;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_PHYSICAL_DISK_SIZE;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_PHYSICAL_DISK_STATUS;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_PHYSICAL_DISK_STATUS_PREDICTED_FAILURE;
