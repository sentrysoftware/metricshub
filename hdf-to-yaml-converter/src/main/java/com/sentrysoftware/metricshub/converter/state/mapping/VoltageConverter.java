...
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_LOWER_THRESHOLD;
...
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_UPPER_THRESHOLD;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_VOLTAGE_TYPE;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_VOLTAGE_VALUE;
...
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_VOLTAGE_HIGH_DEGRADED;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_VOLTAGE_LOW_CRITICAL;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_VOLTAGE_STATUS;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_VOLTAGE_VALUE;
...
public class VoltageConverter extends AbstractMappingConverter {
	...
	protected void setName(ObjectNode existingAttributes, ObjectNode newAttributes) {
		...
		newAttributes.set(
			YAML_NAME,
			new TextNode(wrapInAwkRefIfFunctionDetected(buildNameValue(firstDisplayArgument, voltageType)))
		);
	}
