...
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_LOGICALDISK_TYPE;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_RAID_LEVEL;
...
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_UNALLOCATED_SPACE;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.HDF_USE_FOR_CAPACITY_REPORT;
...
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_LOGICALDISK_ERRORS;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_LOGICALDISK_LIMIT;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_LOGICALDISK_STATUS;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_LOGICALDISK_USAGE_FREE;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_LOGICALDISK_USAGE_USED;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_NAME;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_RAID_LEVEL;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_STATUS_INFORMATION;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_TYPE;
import static com.sentrysoftware.metricshub.converter.ConverterConstants.YAML_USE_FOR_CAPACITY_REPORT;
...
public class LogicalDiskConverter extends AbstractMappingConverter {
	...
	private String buildNameValue(final JsonNode firstDisplayArgument, final JsonNode raidLevel, final JsonNode size) {
		...
		// sprintf("%s (%s - %s)", $1, $2, bytes2HumanFormatBase2($3))
		return format
