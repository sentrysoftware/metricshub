...
import static com.sentrysoftware.matrix.converter.ConverterConstants.HDF_DECODER_USED_TIME_PERCENT;
...
import static com.sentrysoftware.matrix.converter.ConverterConstants.HDF_ENCODER_USED_TIME_PERCENT;
...
import static com.sentrysoftware.matrix.converter.ConverterConstants.HDF_MEMORY_UTILIZATION;
import static com.sentrysoftware.matrix.converter.ConverterConstants.HDF_MEMORY_UTILIZATION_ALARM_THRESHOLD;
import static com.sentrysoftware.matrix.converter.ConverterConstants.HDF_MEMORY_UTILIZATION_WARNING_THRESHOLD;
...
import static com.sentrysoftware.matrix.converter.ConverterConstants.HDF_RECEIVED_BYTES_RATE;
...
import static com.sentrysoftware.matrix.converter.ConverterConstants.HDF_TRANSMITTED_BYTES_RATE;
import static com.sentrysoftware.matrix.converter.ConverterConstants.HDF_USED_TIME_PERCENT;
import static com.sentrysoftware.matrix.converter.ConverterConstants.HDF_USED_TIME_PERCENT_ALARM_THRESHOLD;
import static com.sentrysoftware.matrix.converter.ConverterConstants.HDF_USED_TIME_PERCENT_WARNING_THRESHOLD;
...
import static com.sentrysoftware.matrix.converter.ConverterConstants.YAML_GPU_ENERGY;
import static com.sentrysoftware.matrix.converter.ConverterConstants.YAML_GPU_ERRORS;
import static com.sentrysoftware.matrix.converter.ConverterConstants.YAML_GPU_ERRORS_CORRECTED;
import static com.sentrysoftware.matrix.converter.ConverterConstants.YAML_GPU_IO_RECEIVE;
import static com.sentrysoftware.matrix.converter.ConverterConstants.YAML_GPU_IO_TRANSMIT;
import static com.sentrysoftware.matrix.converter.ConverterConstants.YAML_GPU_MEMORY_LIMIT;
import static com.sentrysoftware.matrix.converter.ConverterConstants.YAML_GPU_MEMORY_UTILIZATION;
import static com.sentrysoftware.matrix.converter.ConverterConstants.YAML_GPU_MEMORY_UTILIZATION_LIMIT_CRITICAL;
import static com.sentrysoftware.matrix.converter.ConverterConstants.YAML_GPU_MEMORY_UTILIZATION_LIMIT_DEGRADED;
import static com.sentrysoftware.matrix.converter.ConverterConstants.YAML_GPU_POWER;
import static com.sentrysoftware.matrix.converter.ConverterConstants.YAML_GPU_PREDICTED_FAILURE;
import static com.sentrysoftware.matrix.converter.ConverterConstants.YAML_GPU_STATUS;
import static com.sentrysoftware.matrix.converter.ConverterConstants.YAML_GPU_UTILIZATION_DECODER;
import static com.sentrysoftware.matrix.converter.ConverterConstants.YAML_GPU_UTILIZATION_ENCODER;
import static com.sentrysoftware.matrix.converter.ConverterConstants.YAML_GPU_UTILIZATION_GENERAL;
import static com.sentrysoftware.matrix.converter.ConverterConstants.YAML_GPU_UTILIZATION_LIMIT_CRITICAL;
import static com.sentrysoftware.matrix.converter.ConverterConstants.YAML_GPU_UTILIZATION_LIMIT_DEGRADED;
