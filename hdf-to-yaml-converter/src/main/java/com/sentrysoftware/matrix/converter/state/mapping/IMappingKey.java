...
public interface IMappingKey {
	 ...
	 * 
	 * @param where where the property key must be set. This is key of the node located under the mapping node
	 * @param newKey the key used to build the {@link MappingKey} instance (metric or attribute key).
	 * @return {@link MappingKey} instance
	 */
	 ...
	 * @return {@link MappingKeyWithValueConverter} instance
	 */
